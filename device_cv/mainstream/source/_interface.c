...
#define INTERFACE_CMD_EXCEPTION_UNKNOWN_CMD		0x8A		//错误的命令字
#define INTERFACE_CMD_EXCEPTION_ERROR_FORMAT	0x8B		//错误的命令格式
#define INTERFACE_CMD_EXCEPTION_DIAG_FAIL		0x8C		//diag失败
